...
// configuration step. It creates a namespace called `compile_time_turing`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", compile_time_turing::cmake::project_name, compile_time_turing::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", compile_time_turing::cmake::project_version);
      return EXIT_SUCCESS;
    }
